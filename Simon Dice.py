...
class SimonDice:
    def __init__(self, ventana):
        #inicializar la venta y las variables del juego
        self.ventana = ventana
        self.ventana.title("Simon Dice")
        self.ventana.geometry("400x500")
        #lista denombres de colores disponibles
        self.colores = list(colores_rgb.keys())
        #secuencia genrada por el juego
        self.secuencia_juego = []
        #secuencia ingresadda por el jugador
        self.secuencia_jugador = []
        #variable para controlar si se espera la entrada 
        #del jugador
        self.esperando_input = False
        #ronda actual
        self.ronda = 1
        #indice para controlar la recursion en la reproduccion
        #de la secuencia
    ...
    def crear_interfaz(self):
        ...
        #crear un marco pra los botones de colores
        self.frame_botones = tk.Frame(self.ventana)
        self.frame_botones.pack(pady=10)
        #crear los botones de colores para que el jugador ingrese la
        #secuencia
        ...
        #crear elboton para empezar el juego
        self.boton_empezar = tk.Button(self.ventana,
                                       text='Empezar juego :D',
                                       command=self.mostrar_secuencia)
    ...
    def reproducir_secuencia(self):
        ...
        if self.indice_secuencia < len(self.secuencia_juego):
            ...
            #si se ha mostrado toda la secuencia, iniciar el turno
            #del jugador
            self.boton_mostrar.config(bg='grey')
            self.iniciar_input_jugador()
            
    def apagar_color(self):
        #apagar el color (volver al color gris)
        self.boton_mostrar.config(bg='grey')
    ...
    def boton_clic(self, nombre_color):
        ...
        if self.esperando_input:
            #añador el color seleccionado por el jugador
            #a su secuencia
            ...
            if self.secuencia_jugador[indice_actual] !=self.secuencia_juego[indice_actual]:
                ...
                #si la secuencia eesta completa y es incorrecta
    ...
    def reiniciar_juego(self):
        ...
        #actualizar la etiqueta de ronda
        self.label_ronda.config(text=f"Ronda {self.ronda}")
